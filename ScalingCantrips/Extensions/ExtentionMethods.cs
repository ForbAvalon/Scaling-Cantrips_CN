...
namespace ScalingCantrips.Extensions
{
  static class ExtentionMethods
  {
    ...
    public static void AddPrerequisite<T>(this BlueprintFeature obj, T prerequisite) where T : Prerequisite
    {
      ...
      switch (prerequisite)
      {
        ...
        case PrerequisiteFeaturesFromList p:
          ...
          features.ForEach(f =>
          {
            f.IsPrerequisiteFor ??= new List<BlueprintFeatureReference>();
    ...
    {
      return components.Where(c => c is not SpellComponent && c is not SpellListComponent);
    }
    ...
    public static void ReplaceComponent(
      this BlueprintScriptableObject blueprint, BlueprintComponent oldComponent, BlueprintComponent newComponent)
    {
    ...
    public static void ReplaceComponents<T>(this BlueprintScriptableObject blueprint, BlueprintComponent newComponent)
      where T : BlueprintComponent
    {
      blueprint.ReplaceComponents<T>(c => true, newComponent);
    }

    public static void ReplaceComponents<T>(
      this BlueprintScriptableObject blueprint, Predicate<T> predicate, BlueprintComponent newComponent) where T : BlueprintComponent
    {
