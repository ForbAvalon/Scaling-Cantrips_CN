...
namespace ScalingCantrips.Utilities
{
  public static class BloodlineTools
  {
    ...
    public static void AddActionIfTrue(this Conditional conditional, GameAction game_action)
    {
      conditional.IfTrue ??= new ActionList();
      conditional.IfTrue.Actions = conditional.IfTrue.Actions.AppendToArray(game_action);
    }

    public static void AddActionIfFalse(this Conditional conditional, GameAction game_action)
    {
    ...
    public static void AddConditionalBuff(this BlueprintBuff parent, BlueprintFeature hasFeature, BlueprintBuff buff)
    {
      ...
      var actionActivated = new Conditional()
      {
        name = parent.name,
        Comment = buff.name,
      ...
      var actionDeactivated = new Conditional()
      {
        name = parent.name,
        Comment = buff.name,
        ConditionsChecker = new ConditionsChecker
    ...
    {
      BlueprintFeatureSelection BloodragerBloodlineSelection =
        Resources.GetBlueprint<BlueprintFeatureSelection>("62b33ac8ceb18dd47ad4c8f06849bc01");
      BlueprintFeatureSelection SecondBloodragerBloodline =
        Resources.GetBlueprint<BlueprintFeatureSelection>("b7f62628915bdb14d8888c25da3fac56");
      BlueprintAbility MixedBloodlineAbility =
        Resources.GetBlueprint<BlueprintAbility>("352b4e8bb5ca4301b6e6084304a86546");
      BlueprintAbility MixedBloodlineAbility2 =
        Resources.GetBlueprint<BlueprintAbility>("291fa8cf38fa401397dd3c9b7515b153");

      SecondBloodragerBloodline.m_Features =
        BloodragerBloodlineSelection.m_AllFeatures.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
      SecondBloodragerBloodline.m_AllFeatures =
        BloodragerBloodlineSelection.m_AllFeatures.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
      BloodragerBloodlineSelection.m_AllFeatures =
        BloodragerBloodlineSelection.m_AllFeatures.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
    ...
    {
      BlueprintFeatureSelection SorcererBloodlineSelection =
        Resources.GetBlueprint<BlueprintFeatureSelection>("24bef8d1bee12274686f6da6ccbc8914");
      BlueprintFeatureSelection SecondBloodline =
        Resources.GetBlueprint<BlueprintFeatureSelection>("3cf2ab2c320b73347a7c21cf0d0995bd");
      BlueprintFeatureSelection BloodlineAscendance =
        Resources.GetBlueprint<BlueprintFeatureSelection>("ce85aee1726900641ab53ede61ac5c19");
    ...
    {
      BlueprintFeatureSelection SorcererFeatSelection =
        Resources.GetBlueprint<BlueprintFeatureSelection>("3a60f0c0442acfb419b0c03b584e1394");
      selection.AddComponent(new PrerequisiteFeature()
      {
        m_Feature = bloodline.ToReference<BlueprintFeatureReference>(),
        Group = Prerequisite.GroupType.All
      });
      SorcererFeatSelection.m_Features =
        SorcererFeatSelection.m_AllFeatures.AppendToArray(selection.ToReference<BlueprintFeatureReference>());
      SorcererFeatSelection.m_AllFeatures =
        SorcererFeatSelection.m_AllFeatures.AppendToArray(selection.ToReference<BlueprintFeatureReference>());
    }

    public static void RegisterCrossbloodedBloodline(BlueprintProgression bloodline)
    {
      BlueprintFeatureSelection CrossbloodedSecondaryBloodlineSelection =
        Resources.GetBlueprint<BlueprintFeatureSelection>("60c99d78a70e0b44f87ba01d02d909a6");
      CrossbloodedSecondaryBloodlineSelection.m_Features =
        CrossbloodedSecondaryBloodlineSelection.m_AllFeatures.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
      CrossbloodedSecondaryBloodlineSelection.m_AllFeatures =
        CrossbloodedSecondaryBloodlineSelection.m_AllFeatures.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
    }

    public static void RegisterSeekerBloodline(BlueprintProgression bloodline)
    {
      BlueprintFeatureSelection SeekerBloodlineSelection =
        Resources.GetBlueprint<BlueprintFeatureSelection>("7bda7cdb0ccda664c9eb8978cf512dbc");
      SeekerBloodlineSelection.m_Features =
        SeekerBloodlineSelection.m_Features.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
      SeekerBloodlineSelection.m_AllFeatures =
        SeekerBloodlineSelection.m_AllFeatures.AppendToArray(bloodline.ToReference<BlueprintFeatureReference>());
