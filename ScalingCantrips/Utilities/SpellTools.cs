...
namespace ScalingCantrips.Utilities
{
  static class SpellTools
  {
    ...
    static readonly Lazy<BlueprintSpellList[]> specialistSchoolList = new(() =>
    {
    ...
    static readonly Lazy<BlueprintSpellList[]> thassilonianSchoolList = new(() =>
    {
      var result = new BlueprintSpellList[(int)SpellSchool.Universalist + 1];
    ...
    static readonly Lazy<SpellSchool[][]> thassilonianOpposedSchools = new(() =>
    {
    ...
    public static class SpellList
    {
      ...
      public static BlueprintSpellList[] AllSpellLists =>
